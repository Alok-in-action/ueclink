...
export function PreferencesScreen({ profile, onStart }) {
  ...
  el.innerHTML = `
    ...
    <div class="page-inner" style="gap:0;">
      ...
      <div style="padding-top:calc(var(--safe-top)+24px);margin-bottom:var(--space-2xl);">
        <div class="wordmark" style="margin-bottom:0;">UEC<span>Link</span></div>
      </div>
      ...
      <div style="animation:fadeUp 0.4s 0.1s var(--ease-out) both;">
        <p style="font-size:12px;font-weight:600;letter-spacing:1px;color:var(--accent-bright);
          text-transform:uppercase;margin-bottom:8px;">Step 2 of 2</p>
      ...
      <div style="margin-top:var(--space-md);padding:12px 14px;
        ...
        <p style="font-size:12px;color:var(--text-secondary);line-height:1.5;">
          🔒 Your identity stays anonymous unless <em>both</em> of you choose to reveal.
        </p>
      </div>
